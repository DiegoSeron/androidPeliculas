...
public class PeliculasDAO implements DAO<Peliculas, Integer> {
    ...
    public ArrayList<Peliculas> getGeneroDeporte(Peliculas bean){
      String sql_filtro = "2";
        String sql_final = "";
         ArrayList<Peliculas> lstPeliculas = null;
          try {
    ...
    public ArrayList<Peliculas> getGeneroBiografica(Peliculas bean){
      String sql_filtro = "3";
        String sql_final = "";
         ArrayList<Peliculas> lstPeliculas = null;
          try {
    ...
    public ArrayList<Peliculas> getGeneroBelica(Peliculas bean){
      String sql_filtro = "5";
        String sql_final = "";
         ArrayList<Peliculas> lstPeliculas = null;
          try {
